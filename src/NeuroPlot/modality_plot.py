...
class ModalityPlot:
    ...
    def __init__(self,
                 ...
                 linewidth = 0.5,
                 alpha = 0.8,
                 same_scale = True,    # Draw all the subplots in the same scale
        ...
        self.binarization = np.array(binarization, dtype=np.bool_)
    ...
    def vector_addition(self, data, binarization) -> list:
    ...
    def draw_subplot(self, ax, resultants, modality_pattern, modalities) -> None:
